...
cmdclass['jsdeps'] = combine_commands(
    install_npm(js_dir, npm=['yarn'], build_cmd='build:nbextension'), ensure_targets(jstargets),
)

setup_args = dict(
    name=name,
    version=version,
    description='A Python widget for Quirk',
    ...
    author_email='aditya.giridharan@gmail.com',
